...
export const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-8 lg:px-10 w-full py-12 sm:py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          {/* Left Column (7 cols) */}
          <div className="lg:col-span-7 flex flex-col items-start">
            <span className="text-[#B88A32] font-semibold text-[11px] sm:text-xs tracking-[0.25em] sm:tracking-[0.3em] uppercase block mb-3 sm:mb-4">
              {hero.kicker}
            </span>

            <h1 className="font-serif text-4xl sm:text-6xl xl:text-7xl font-bold leading-[0.96] sm:leading-[0.94] mb-5 sm:mb-6 tracking-tight">
            ...
            <p className="text-[#EEE8D7] opacity-75 text-sm sm:text-base max-w-md mb-8 sm:mb-10 leading-relaxed font-light">
              {hero.description}
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
              <Link
                id="hero-shop-cta"
                to="/shop"
                className="px-7 sm:px-8 py-3.5 sm:py-4 bg-[#B88A32] text-[#10110F] font-bold text-xs tracking-widest uppercase hover:bg-[#D4B66A] transition-all shadow-xl rounded-sm text-center min-h-[44px] flex items-center justify-center"
              >
              ...
              <Link
                id="hero-guide-cta"
                to="/why-titan"
                className="px-7 sm:px-8 py-3.5 sm:py-4 border border-[#F7F3E8]/30 text-[#F7F3E8] font-bold text-xs tracking-widest uppercase hover:bg-white/10 transition-all rounded-sm text-center min-h-[44px] flex items-center justify-center"
              >
            ...
            {/* Micro Trust Proof */}
            <div className="pt-6 sm:pt-8 mt-6 sm:mt-8 border-t border-white/10 flex flex-wrap items-center gap-4 sm:gap-6 text-[11px] sm:text-xs text-[#EEE8D7]/75">
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center lg:justify-end pb-6 sm:pb-12 mt-4 lg:mt-0">
            <div className="relative w-full max-w-[300px] sm:max-w-[360px] bg-[#10110F] border border-[#B88A32]/30 p-2 sm:p-3 shadow-2xl rounded-sm">
              ...
              <div className="absolute -bottom-4 -left-4 sm:-bottom-8 sm:-left-8 bg-[#F7F3E8] p-4 sm:p-6 shadow-2xl border border-[#10110F]/10 rounded-sm z-30">
                <p className="font-serif italic text-xl sm:text-3xl text-[#183D27] leading-none font-bold">
                  {hero.purityPercent || '98.2% Purity'}
                </p>
                <p className="text-[9px] sm:text-[10px] uppercase tracking-widest mt-1 opacity-70 font-sans font-bold text-[#10110F]">
